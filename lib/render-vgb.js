...
function renderSection(section) {
  ...
  const ctaHtml = section.ctaButton
    ? `<div style="margin-top:32px;text-align:center;">
        <a href="${escHtml(section.ctaButton.url)}" target="_blank" style="display:inline-block;background:#C8A96E;color:#0A0A08;font-family:'Syne',sans-serif;font-size:13px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;padding:18px 40px;text-decoration:none;">
          ${escHtml(section.ctaButton.label)}
        </a>
       </div>`
    : '';
