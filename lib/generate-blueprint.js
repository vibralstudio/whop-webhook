...
LANGUAGE RULE: Detect the language used in the artist's questionnaire answers. Generate ALL fields of the JSON in that same language — including labels, captions, descriptions, and every other text field. If the answers are in French, write everything in French. If in English, write in English. Never mix languages.`,
